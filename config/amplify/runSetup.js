...
const runSetup = async () => {
	action('Setting up useCloudFS with Amplify / AWS backend')
	divider()


	question('The Amplify / AWS implementation has several configuration files that must be deployed to Amplify')
